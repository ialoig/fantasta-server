        ...
        try
        {
            ...
            if (footballPlayerListOld_obj && footballPlayerListOld_obj.footballPlayers) {
                ...
                if (!equals) {
                    ...
                    console.log(`[saveFootballPlayers] deleting FootballPlayer collection version: ${versionOld}`);
                    ...
                    console.log(`[saveFootballPlayers] FootballPlayer collection is up to date. Current version: ${versionOld}`);
                }
            }
